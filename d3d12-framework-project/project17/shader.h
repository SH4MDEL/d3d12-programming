...
class StencilRenderShader : public Shader
{
public:
	StencilRenderShader(const ComPtr<ID3D12Device>& device, const ComPtr<ID3D12RootSignature>& rootSignature);
	~StencilRenderShader() = default;
