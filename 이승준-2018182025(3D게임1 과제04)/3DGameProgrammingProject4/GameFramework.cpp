...
{
	CAirplanePlayer* Player = (CAirplanePlayer*)m_pVPlayer;
	switch (nMessageID)
	{
	case WM_KEYUP:
		switch (wParam)
...
void CGameFramework::ProcessInput()
{
	...
	if (m_iSelectedScene == 1) {
		...
		m_pVScene->CheckPlayerByObjectCollisions();
		m_pVPlayer->SavePosition();
	}
