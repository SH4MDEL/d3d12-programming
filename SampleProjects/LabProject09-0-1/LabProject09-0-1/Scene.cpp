...
//	CGaussian1DBlurComputeShader *pComputeShader = new CGaussian1DBlurComputeShader();
...
void CScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	ID3D12Resource *pd3dSource = ((CGaussian2DBlurComputeShader*)m_ppComputeShaders[0])->m_pTexture->GetResource(1);
