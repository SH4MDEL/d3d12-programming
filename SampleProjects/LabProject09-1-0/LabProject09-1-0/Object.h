...
public:
	...
	void SetRootParameterIndex(int nIndex, int nRootParameterIndex);
...
#else
	int GetWidth() { return(int(m_nWidth * m_xmf3Scale.x)); }
	int GetLength() { return(int(m_nLength * m_xmf3Scale.z)); }
#endif
};
