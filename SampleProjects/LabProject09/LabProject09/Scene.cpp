...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[0].BaseShaderRegister = 2; //t2: Texture2D
...
void CScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	ID3D12Resource *pd3dSource = ((CAddTexturesComputeShader*)m_ppComputeShaders[0])->m_pTexture->GetResource(2);
	...
	ID3D12Resource *pd3dDestination = ((CTextureToFullScreenShader*)m_ppGraphicsShaders[0])->m_pTexture->GetResource(0);
