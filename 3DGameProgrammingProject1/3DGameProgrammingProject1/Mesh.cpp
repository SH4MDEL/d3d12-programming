...
CRailMesh::CRailMesh(float fWidth = 1.0f, float fDepth = 1.0f) : CMesh(1)
{
	float fHalfWidth = fWidth * 0.5f;
	float fHalfDepth = fDepth * 0.5f;

	CPolygon* pRail = new CPolygon(4);
	pRail->SetVertex(0, CVertex(-fHalfWidth, 0.0f, -fHalfDepth));
	pRail->SetVertex(1, CVertex(-fHalfWidth, 0.0f, +fHalfDepth));
	pRail->SetVertex(2, CVertex(+fHalfWidth, 0.0f, +fHalfDepth));
	pRail->SetVertex(3, CVertex(+fHalfWidth, 0.0f, -fHalfDepth));
