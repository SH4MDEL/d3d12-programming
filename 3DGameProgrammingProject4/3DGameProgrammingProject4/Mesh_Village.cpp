...
CMesh_Village::CMesh_Village(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, char* pstrFileName)
{
	//std::cout << pstrFileName << endl;
	if (pstrFileName) LoadMeshFromFile(pd3dDevice, pd3dCommandList, pstrFileName);
}

CMesh_Village::~CMesh_Village()
{
...
void CMesh_Village::ReleaseUploadBuffers()
{
...
void CMesh_Village::OnPreRender(ID3D12GraphicsCommandList* pd3dCommandList)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
	pd3dCommandList->IASetVertexBuffers(m_nSlot, m_nVertexBufferViews, m_pd3dVertexBufferViews);
}

void CMesh_Village::Render(ID3D12GraphicsCommandList* pd3dCommandList, UINT nSubset)
{
	if (m_nSubsets > 0)
	{
...
void CMesh_Village::LoadMeshFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, char* pstrFileName)
{
